 ...
 */
export function resolveSpecCliPaths(projectRoot) {
 ...
 */
export function getAssetPath(assetType, name) {
    const packageRoot = getPackageRoot();
 ...
 */
export function readAsset(assetType, name) {
    const assetPath = getAssetPath(assetType, name);
